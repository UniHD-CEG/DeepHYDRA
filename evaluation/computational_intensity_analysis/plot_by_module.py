...
if __name__ == '__main__':
    ...
    for file in os.listdir(data_dir):
        ...
        flops_all = results.get_level(0)['root']

        flops_summed = 0

        for flops in results_level_1.values():
            flops_summed += flops

        print(f'{model_name}: Deviation from reported sum: '\
                f'{100*(flops_all - flops_summed)/flops_all:.3f} %')
    ...
    plt.savefig(f'plots/computational_intensity_comparison_by_module.png')