...
def parameter_exploration(data: np.array,
    ...
    results_best.to_csv('parameters_best_method_3_hlt.csv', sep='\t')
    ...
    results_best.to_csv('parameters_best_method_4_hlt.csv', sep='\t')
...
def test_thresholds_method_3(data: np.array,
    ...
    results_combined.to_csv('results_method_3_combined_hlt.csv', sep='\t')
...
def test_thresholds_method_4(data: np.array,
    ...
    results_combined.to_csv('results_method_4_combined_hlt.csv', sep='\t')
