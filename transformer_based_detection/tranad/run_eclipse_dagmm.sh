...
do
    ...
    python3 main.py --model DAGMM --seed=${seed} --dataset "ECLIPSE_MEAN" --retrain --apply_augmentations --augmentations 'Roll:0,1' 'Roll:0,1' 'Roll:0,1' 'Roll:0,1' 'Roll:0,1' 'Roll:0,1' 'Roll:0,1' 'Roll:0,1'
done